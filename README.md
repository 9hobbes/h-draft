...
### 2. 파일 관리
파일 저장, 열기 등을 지원합니다. <i>버전 관리, 버전 간 차이점 보기 기능은 작가를
위한 편집기라면 필요하지 않을까?</i>

### 3. 자동 맞춤법 교정
#### 3.1 편집기 컨트롤의 맞춤법 API
...
### 5. 메뉴 아이템
#### 5.1 빨간색 점선이 그어진 (교정 대상) 문자열의 컨텍스트 메뉴
##### 추천 문자열 리스트
##### 교정 정보
##### 직접 교정하기
##### 무시하기
...
#### 5.2 회색 점선이 그어진 (교정된) 문자열의 컨텍스트 메뉴
##### 되돌리기

#### 5.3 옅은 노란색 점선이 그어진 (무시된) 문자열의 컨텍스트 메뉴
##### 추천 문자열 리스트
##### 교정 정보
##### 직접 교정하기
##### 제외하기
...
#### 4. H Draft 컴포넌트 개발
##### 4.1 컨텍스트 메뉴 컴포넌트 개발
##### 4.2 교정 정보와 몇 개의 메뉴를 가진 팝업 윈도우 컴포넌트 개발
##### 4.3 Draft.js 컴포넌트의 텍스트에 밑줄 넣고 메뉴나 윈도우를 뛰우는 기능 개발
#### 5. 맞춤법 인덱스 모듈 개발
##### 5.1 적합한 데이터베이스 선택
##### 5.2 문장으로 맞춤법 인덱스를 검색하는 기능 개발
