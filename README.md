...
웹 브라우저의 기본 컴포넌트와 차이점은 다음과 같습니다.
...
가장 큰 문제는 단어 개수의 2~3배 정도를 검색해야 한다는 점입니다. 다음의 
문장을 살펴봅시다.
...
## 주요 개발 단위
### 기초적인 리액트 개발 방법 공부
### 기초적인 Draft.js 사용법 공부
### 기초적인 일렉트론 개발 방법 공부
### H Draft 컴포넌트 개발
#### 컨텍스트 메뉴 컴포넌트 개발
#### 교정 정보와 몇 개의 메뉴를 팝업 윈도우 컴포넌트 개발
#### Draft.js 컴포넌트의 텍스트에 밑줄 넣어주는 기능
### 맞춤법 인덱스 모듈 개발
#### 적합한 데이터베이스 선택
#### 주어진 문장으로 맞춤법 인덱스를 검색한 뒤 발견된 문자열을 변경하는 기능 개발
